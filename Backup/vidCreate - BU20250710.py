...
def process_regular_image(row_id, file_data, title, target_width, target_height):
    """Process a regular image from DB data: background, stars, enlarge, center, title overlay."""
    try:
        ...
        # Enlarge slightly before thumbnailing
        scale_factor = 1.2  # make image appear larger
